...
#=================================================================================
  ...
  # Create ports
  set ad7606_os [ create_bd_port -dir O -from 2 -to 0 ad7606_os ]
  set ad7606_first_data [ create_bd_port -dir I ad7606_first_data ]
  set ad7606_busy [ create_bd_port -dir I ad7606_busy ]
  set ad7606_convstab [ create_bd_port -dir O ad7606_convstab ]
  set ad7606_reset [ create_bd_port -dir O -type rst ad7606_reset ]
  set ad7606_rd [ create_bd_port -dir O ad7606_rd ]
  set ad7606_cs [ create_bd_port -dir O ad7606_cs ]
  set ad7606_data [ create_bd_port -dir I -from 15 -to 0 ad7606_data ]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXI_MM2S [get_bd_intf_pins axi_vdma_0/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S02_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_pins processing_system7_0/IIC_0] [get_bd_intf_ports hdmi_ddc]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ad7606_sample_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  ...
  connect_bd_net -net ad7606_busy_0_1 [get_bd_ports ad7606_busy] [get_bd_pins ad7606_sample_0/ad7606_busy]
  connect_bd_net -net ad7606_data_0_1 [get_bd_ports ad7606_data] [get_bd_pins ad7606_sample_0/ad7606_data]
  connect_bd_net -net ad7606_first_data_0_1 [get_bd_ports ad7606_first_data] [get_bd_pins ad7606_sample_0/ad7606_first_data]
  connect_bd_net -net ad7606_sample_0_ad7606_convstab [get_bd_pins ad7606_sample_0/ad7606_convstab] [get_bd_ports ad7606_convstab]
  connect_bd_net -net ad7606_sample_0_ad7606_cs [get_bd_pins ad7606_sample_0/ad7606_cs] [get_bd_ports ad7606_cs]
  connect_bd_net -net ad7606_sample_0_ad7606_os [get_bd_pins ad7606_sample_0/ad7606_os] [get_bd_ports ad7606_os]
  connect_bd_net -net ad7606_sample_0_ad7606_rd [get_bd_pins ad7606_sample_0/ad7606_rd] [get_bd_ports ad7606_rd]
  connect_bd_net -net ad7606_sample_0_ad7606_reset [get_bd_pins ad7606_sample_0/ad7606_reset] [get_bd_ports ad7606_reset]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins ad7606_sample_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins util_ds_buf_1/BUFG_O] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins rst_ps7_0_142M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins ad7606_sample_0/m00_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins rst_clk_adc/slowest_sync_clk] [get_bd_pins ad7606_sample_0/adc_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins util_ds_buf_0/BUFG_I]
  connect_bd_net -net processing_system7_0_FCLK_CLK4 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins util_ds_buf_1/BUFG_I]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins ad7606_sample_0/s00_axi_aresetn]
  connect_bd_net -net rst_ps7_0_142M_peripheral_aresetn [get_bd_pins rst_ps7_0_142M/peripheral_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins ad7606_sample_0/m00_axis_aresetn]
  ...
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ad7606_sample_0/S00_AXI/S00_AXI_reg] -force
