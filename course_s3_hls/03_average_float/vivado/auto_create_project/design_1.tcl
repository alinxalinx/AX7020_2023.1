...
xilinx.com:hls:average_float:1.0\
"
...
\
  ...
  # Create instance: average_float_0, and set properties
  set average_float_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:average_float:1.0 average_float_0 ]
  set_property CONFIG.C_M_AXI_GMEM_ENABLE_ID_PORTS {false} $average_float_0


  # Create interface connections
  connect_bd_intf_net -intf_net average_float_0_m_axi_gmem [get_bd_intf_pins average_float_0/m_axi_gmem] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins average_float_0/s_axi_control]

  # Create port connections
  connect_bd_net -net average_float_0_interrupt [get_bd_pins average_float_0/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins average_float_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins average_float_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs average_float_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces average_float_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
