...
xilinx.com:hls:led_register:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led_V_0 [ create_bd_port -dir O -from 0 -to 0 -type data led_V_0 ]
...
\
  ...
  # Create instance: led_register_0, and set properties
  set led_register_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:led_register:1.0 led_register_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins led_register_0/s_axi_control]

  # Create port connections
  connect_bd_net -net led_register_0_led_V [get_bd_pins led_register_0/led] [get_bd_ports led_V_0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins led_register_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins led_register_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_register_0/s_axi_control/Reg] -force
