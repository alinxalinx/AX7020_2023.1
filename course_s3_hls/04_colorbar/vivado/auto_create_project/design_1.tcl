...
\
  ...
  # Create instance: colorbar_0, and set properties
  set colorbar_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:colorbar:1.0 colorbar_0 ]
 ...
 ] [get_bd_intf_pins /colorbar_0/dst]

  # Create interface connections
  connect_bd_intf_net -intf_net colorbar_0_dst [get_bd_intf_pins colorbar_0/dst] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_dynclk_0/s00_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins colorbar_0/s_axi_control]
  ...
  connect_bd_net -net M03_ACLK_1 [get_bd_pins util_ds_buf_1/BUFG_O] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rst_ps7_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins colorbar_0/ap_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins util_ds_buf_0/BUFG_I]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN]
  connect_bd_net -net rst_ps7_0_150M_interconnect_aresetn [get_bd_pins rst_ps7_0_150M/interconnect_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN]
  connect_bd_net -net rst_ps7_0_150M_peripheral_aresetn [get_bd_pins rst_ps7_0_150M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins colorbar_0/ap_rst_n]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs colorbar_0/s_axi_control/Reg] -force
