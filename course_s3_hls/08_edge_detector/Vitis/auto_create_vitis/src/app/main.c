...
XEdge_detector edgeDetectorInstance;
...
int main()
{
	...
	if (XEdge_detector_Initialize(&edgeDetectorInstance, XPAR_EDGE_DETECTOR_0_DEVICE_ID) != XST_SUCCESS)
	{
		printf("XEdge_detector_Initialize fail\n");
		return -1;
	}

	XEdge_detector_Set_threshold(&edgeDetectorInstance, 40);
