#////////////////////////////////////////////////////////////////////////////////
#  project：FPGA on-chip RAM read and write test experiment                    //
#                                                                              //
#  Author: JunFN                                                               //
#          853808728@qq.com                                                    //
...
#设置项目名称和工作目录
set projname "vivado_ram"
set Topname "ram_test"
set tclpath [pwd]
cd ..
set projpath [pwd]
#创建工程
...
# 添加IP
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name ram_ip
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/ram_ip/ram_ip.xci]
