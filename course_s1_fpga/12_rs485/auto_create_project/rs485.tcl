...
#设置项目名称和工作目录
set projname "vivado_rs485"
set Topname "rs485_top"
set tclpath [pwd]
cd ..
set projpath [pwd]
#创建工程
...
# 添加IP
create_ip -name fifo_generator -vendor xilinx.com -library ip -version 13.2 -module_name rx_fifo
set_property -dict [list \
  CONFIG.Input_Data_Width {8} \
  CONFIG.Input_Depth {256} \
] [get_ips rx_fifo]
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/rx_fifo/rx_fifo.xci]
#*********************************************************************************************************
#添加源文件
