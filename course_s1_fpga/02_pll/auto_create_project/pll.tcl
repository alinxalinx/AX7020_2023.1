#////////////////////////////////////////////////////////////////////////////////
#  project：PLL experiment under Vivado                                        //
#                                                                              //
#  Author: JunFN                                                               //
#          853808728@qq.com                                                    //
...
#设置项目名称和工作目录
set projname "vivado_pll"
set Topname "pll_test"
set tclpath [pwd]
cd ..
set projpath [pwd]
#创建工程
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci]
#*********************************************************************************************************
#添加源文件
