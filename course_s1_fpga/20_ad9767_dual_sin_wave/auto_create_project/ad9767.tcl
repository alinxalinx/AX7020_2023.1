#////////////////////////////////////////////////////////////////////////////////
#  project：AD9767 dual channel sine wave generation experiment                //
#                                                                              //
#  Author: JunFN                                                               //
#          853808728@qq.com                                                    //
...
#设置项目名称和工作目录
set projname "vivado_ad9767"
set Topname "ad9767_test"
set tclpath [pwd]
cd ..
set projpath [pwd]
#创建工程
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/PLL/PLL.xci]

create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name ROM
set_property -dict [list \
  CONFIG.Coe_File $tclpath/sin1024.coe \
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/ROM/ROM.xci]
#*********************************************************************************************************
#添加源文件
