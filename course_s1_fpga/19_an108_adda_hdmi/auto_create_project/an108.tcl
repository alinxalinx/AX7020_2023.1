...
create_ip -name clk_wiz -vendor xilinx.com -library ip -version 6.0 -module_name adda_pll
set_property -dict [list \
  CONFIG.CLKIN1_JITTER_PS {200.0} \
  CONFIG.CLKOUT1_JITTER {218.404} \
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/adda_pll/adda_pll.xci]
...
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name da_rom
set_property -dict [list \
  CONFIG.Coe_File $tclpath/sin512.coe \
...
generate_target {instantiation_template} [get_files $projpath/$projname/$projname.srcs/sources_1/ip/da_rom/da_rom.xci]
#*********************************************************************************************************
#添加源文件
