...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DMA_TYPE" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "HAS_RX" -parent ${Page_0}
  ipgui::add_param $IPINST -name "HAS_TX" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NUM_OF_CHANNEL" -parent ${Page_0}
  ipgui::add_param $IPINST -name "LRCLK_POL" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BCLK_POL" -parent ${Page_0}
