...
#*********************************************************************************************************
#添加源文件
add_files -fileset sources_1  -copy_to $projpath/$proj_name/$proj_name.srcs/sources_1/new -force -quiet [glob -nocomplain $tclpath/src/design/*.v]
#添加约束文件
...
# 设置顶层文件属性
set_property top_file "/$projpath/$proj_name/$proj_name.srcs/sources_1/new/$Topname.v" [current_fileset]
#运行综合、实现和生成比特流
...
place_design
route_design
write_bitstream -force $projpath/$proj_name/$proj_name.runs/impl_1/$Topname.bit
write_debug_probes -file $projpath/$proj_name/$proj_name.runs/impl_1/$Topname.ltx
# 生成硬件平台文件
...
add_files -fileset sources_1  -copy_to $projpath -force -quiet [glob -nocomplain $projpath/$proj_name/$proj_name.runs/impl_1/*.ltx]
