...
set appName freeos_led

#Create a new platform
platform create -name $xsaName -hw $projpath/$xsaName.xsa -proc ps7_cortexa9_0 -os freertos10_xilinx -arch 32-bit -out $projpath
...
app create -name $appName -platform $xsaName -domain freertos10_xilinx_domain -template "Empty Application"
